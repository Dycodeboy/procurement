...
public class User implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPasword() == null ? other.getPasword() == null : this.getPasword().equals(other.getPasword()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPasword() == null) ? 0 : getPasword().hashCode());
